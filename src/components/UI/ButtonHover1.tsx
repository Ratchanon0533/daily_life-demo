      ...
      <div className="btn-wrapper">
        <button className="btn">
          ...
          <div className="txt-wrapper">
            <div className="txt-1">
              <span className="btn-letter">{text}</span>
            </div>
            <div className="txt-2">
              <span className="btn-letter">{text}</span>
            </div>
...
const StyledWrapper = styled.div`
  ...
  .btn {
    ...
    --padding: 4px;
    --transition: 0.4s;
    --button-color: #033E65; /* Same as background */
  ...
  .btn::before {
    ...
    pointer-events: none;
    background-image: linear-gradient(0deg, #0004, #);
    ...
    box-shadow:
      0 -8px 8px -6px #033E65 inset,
      0 -16px 16px -8px #033E65 inset,
      1px 1px 1px #fff2,
      2px 2px 2px #,
      -1px -1px 1px #,
      // -2px -2px 2px #0001;
